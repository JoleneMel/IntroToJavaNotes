...
public static void main(String[] arg) {
	...
	BodyOfMethod
		...
		Here, these parts of the method declaration are explained below:
	            ...
	            BodyofMethod, this is where you put your code… anything that you want to accomplish in that particular method.  
	            All Java code, and will include variable declarations, method calls, etc.
