...
public class Equality {
	...
	public static void main(String[] args) {
		...
		//Another difference between Primitive Datatypes and Objects has to do with Equality.   
		//The Equality Operator in Java == checks to see if two references are the same.  In other words when comparing 
		//Primitive Datatypes,  == checks to see if two values are the same.  With Primitive Datatype Equality Comparison, 
		//== checks the in-memory value of the Primitive Datatype against the in-memory value of a different Primitive Datatype.   
